    ...
    <div>
      ...
      <main style={contentStyles}>
        <ContentTransition delay={200}>
          <h1 style={titleStyles} className={cl.slideInLeft}>
            Навыки
          </h1>
        </ContentTransition>
        <ContentTransition delay={400}>
          <p style={subtitleStyles} className={cl.slideInRight}>
            Здесь будет список моих технических навыков и компетенций.
          </p>
        </ContentTransition>
      </main>
    </div>
